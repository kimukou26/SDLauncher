...
application(title:'HudsonAssembler',
  size:[600,400],
  locationByPlatform:true,
  iconImage: imageIcon('/hudson-48x48.png').image,
  iconImages: [imageIcon('/hudson-48x48.png').image,
               imageIcon('/hudson-32x32.png').image,
               imageIcon('/hudson-16x16.png').image]
) {
...
//20101105 mod end kimukou.buzz
    ...
    menuBar {
        ...
        menu(text:'Assemble') {
            menuItem(text:'Assemble Hudson', actionPerformed:{assembleFileChooser.showSaveDialog(mainPanel)})
        }        
    }
